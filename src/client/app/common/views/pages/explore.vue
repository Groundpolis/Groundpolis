...
import { faChartLine, faPlus, faHashtag, faCertificate, faRocket } from '@fortawesome/free-solid-svg-icons';
...
export default Vue.extend({
	...
	data() {
		return {
			...
			faBookmark, faChartLine, faCommentAlt, faPlus, faHashtag, faCertificate, faRocket
		};
	},
