...
export const router = createRouter({
	...
	routes: [
		...
		{ path: '/search', redirect: route => `/search/${route.query.f || 'notes'}/${route.query.q || ''}` },
		{ path: '/search/:f/:q', component: page('search'), props: route => ({ q: route.params.q, f: route.params.f, }) },
