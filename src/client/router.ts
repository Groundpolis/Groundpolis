...
export const router = createRouter({
	...
	routes: [
		...
		{ path: '/composer', component: page('composer') },
		{ path: '/composer/:songId', component: page('composer/song') },
		{ path: '/composer/:songId/edit', component: page('composer/edit') },
		{ path: '/composer/new', component: page('composer/new') },
		...
		// { path: '/games', component: page('games') },
