...
<div class="_card tbkwesmv">
	...
	<div class="_footer navigation">
		<div class="step">
			...
			<button class="arrow _button" @click="tutorial++" :disabled="tutorial === 5">
				<fa :icon="faChevronRight"/>
			</button>
		</div>
		<mk-button class="ok" @click="tutorial = -1" primary v-if="tutorial === 5"><fa :icon="faCheck"/> {{ $t('gotIt') }}</mk-button>
