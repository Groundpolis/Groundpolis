...
<FormBase class="znqjceqz">
	...
	<FormGroup>
		<FormLink to="https://github.com/Groundpolis/Groundpolis" external><template #icon><Fa :icon="faCode"/></template>{{ $t('_aboutMisskey.source') }}</FormLink>
		<FormLink to="https://github.com/syuilo/misskey" external><template #icon><Fa :icon="faCode"/></template>{{ $t('_aboutMisskey.sourceMisskey') }}</FormLink>
