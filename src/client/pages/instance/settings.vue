...
<div v-if="meta">
	...
	<section class="_section info">
		...
		<div class="_content">
			<MkSwitch v-model:value="enableFeatured" @update:value="save()">{{ $t('enableFeatured') }}</MkSwitch>
	...
	<section class="_section info">
		...
		<div class="_content">
			...
			<template v-if="!enableRegistration">
				<MkSwitch v-if="!enableRegistration" v-model:value="enableInvitation" @update:value="save()">{{ $t('enableInvitation') }}</MkSwitch>
				<template v-if="!enableInvitation">
					<MkInput v-model:value="disableInvitationReason">{{ $t('disableInvitationReason') }}</MkInput>
					<MkButton primary @click="save(true)"><fa :icon="faSave"/> {{ $t('save') }}</MkButton>
				</template>
				<MkButton v-else @click="invite">{{ $t('invite') }}</MkButton>
			</template>
		</div>
	</section>
	...
	<section class="_section">
		...
		<div class="_content">
			...
			<MkInput v-model:value="premiumDriveCapacityMb" type="number">{{ $t('driveCapacityPerRemoteAccount') }}<template #suffix>MB</template><template #desc>{{ $t('inMb') }}</template></MkInput>
		</div>
		<div class="_footer">
			<MkButton primary @click="save(true)"><Fa :icon="faSave"/> {{ $t('save') }}</MkButton>
		</div>
